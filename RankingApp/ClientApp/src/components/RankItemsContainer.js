...
const RankItemsContainer = ({ dataType, imgArr }) => {
    ...
    const [albumItems, setAlbumItems] = useState(JSON.parse(sessionStorage.getItem(albumLocalStorageKey)));
    const [movieItems, setMovieItems] = useState(JSON.parse(sessionStorage.getItem(movieLocalStorageKey)));
